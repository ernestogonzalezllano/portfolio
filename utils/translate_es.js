export default {
    ...
    about_p1:"Como web developer estoy enfocado a ",
    about_str1:"aprender ",
    about_p2:"al máximo, ",
    about_str2:"adaptarme ",
    about_p3:"y afrontar todos y cada uno de los desafíos que se me asignen, ",
    about_str3:"aportar ",
    about_p4:"mi experiencia en proyectos grupales e indivuales, tanto en backend y frontend y nutrirme de nuevas habilidades, que junto con las propias, me permitan maximizar cada vez más mi capacidad de ",
    about_str4:"transformar ",
    about_p5:"programas,empresas, realidades y vidas",

    tech_title:"Tecnologías",

    soft_title:"Habilidades",
    soft_label1:"creatividad",
    soft_label2:"adaptación",
    soft_label3:"innovación",
    soft_label4:"escucha activa",

    experience_title:"Experiencia",
    experience_epayco_job:"Desarrollo y mantenimiento de soluciones de pago de tipo suscripcion.",
    experience_epayco_date:"01-2021 / Actualidad",
    experience_innova_job:"Desarrollo de sitio Web y AdminPage.",
